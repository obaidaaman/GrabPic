...
user_router = APIRouter(prefix="/users/spaces", tags=["Spaces"])




@user_router.post("/", status_code=status.HTTP_201_CREATED, response_model=SpaceResponseSchema)
...
@user_router.get("/", status_code=status.HTTP_200_OK, response_model=List[SpaceResponseSchema])
...
@user_router.post("/join", status_code=status.HTTP_200_OK, response_model= SpaceResponseSchema)
...
@user_router.get("/images",status_code=status.HTTP_200_OK,response_model=List[ImagesResponseSchema])
